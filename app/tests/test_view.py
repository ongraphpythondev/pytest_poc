...
class TestChangePassword:
    ...
    @pytest.mark.django_db
    def test_change_password_user_not_login_with_correct_account(self,api_client , create_user , login_user , django_user_model):    

        django_user_model.objects.create_user(username="manish", email="manishpandey1200@gmail.com" , password="pandey1200")
    ...
    @pytest.mark.django_db
    def test_change_password_user_password_not_correct(self,api_client , create_user , login_user):    
    ...
    @pytest.mark.django_db
    def test_change_password_pass1_and_pass2_incorrect(self,api_client , create_user , login_user):    
